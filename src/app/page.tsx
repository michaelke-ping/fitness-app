    ...
    <div className="max-w-[480px] mx-auto px-4 py-6">
      ...
      {!loading && !schedule && (
        <div className="text-center py-12">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">No workout scheduled for today. Recover and come back stronger.</p>
        </div>
      )}
            ...
            {schedule.schedule_exercises.map((exercise) => (
              ...
              >
                ...
                {exercise.notes && (() => {
                  ...
                  return (
                    <div className="mt-2">
                      {desc && <p className="text-zinc-400 dark:text-zinc-500 text-sm">{desc.trim()}</p>}
                      {url && (
                        <a
                          href={url.trim()}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-500 dark:text-blue-400 text-sm mt-1 inline-block hover:underline"
                        >
